...
function TableColumns() {
    ...
    const fetchAll = async ({ showSpinner } = { showSpinner: true }) => {
      try {
        ...
        const [columnsRes, devRes] = await Promise.all([
          fetch(`${API_URL}/api/columns-marketing`),
  ...
  const handleOnDragEnd = async (result) => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/columns-marketing/reorder/update`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSaveOptions = async ({ multipleValue, optionColors, optionTextColors }) => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/columns-marketing/${selectedColorCol.name}/options`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSaveColumnAccess = async (columnName, { access, column_heading, sorting, equalPrefix, morePrefix, lessPrefix, showInfo }) => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/columns-marketing/${columnName}/access`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/columns-marketing/deactivate/${accessor}`, {
        method: "PATCH",
      });
  ...
  const handleRename = async (oldName, newName) => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/columns-marketing/${oldName}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
    ...
    <section className="">
      ...
      <Form
        ...
        onPopupSave={async (newColumn) => {
          try {
            const res = await fetch(`${API_URL}/api/columns-marketing`, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
