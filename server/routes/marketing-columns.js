...
router.post("/", async (req, res) => {
    try {
        const { column_heading, column_type, multipleValue, sorting, conditionColumn1, conditionColumn2, equalPrefix, morePrefix, lessPrefix, hasDefaultValue, rowpopup_column, showInMainProject, defaultValue, access, viewAccess, sticky, showYear } = req.body;
        if (!column_heading) {
